...
const steps = ['Load information', 'Loan Eligibility ', 'Personal Information','Documents'];
...
export default function HorizontalLinearStepper() {
  ...
  return (
   <Box display={'flex'}   flexDirection={'column'} height={'100vh'}justifyContent={'flex-end'}>
